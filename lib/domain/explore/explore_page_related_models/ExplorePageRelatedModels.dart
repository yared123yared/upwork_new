...
@freezed
abstract class ProductActionModel with _$ProductActionModel {
  factory ProductActionModel({
  ...
  factory ProductActionModel.fromJson(Map<String, dynamic> json) => _$ProductActionModelFromJson(json);
//require keysetting
}

@freezed
abstract class ProductActionResponse with _$ProductActionResponse {
  factory ProductActionResponse({
    @JsonKey(name:'errorid')int errorid,
    @JsonKey(name:'errormsg')String errormsg,
    @JsonKey(name:'productid')String productid,

  }) = _ProductActionResponse;
  factory ProductActionResponse.fromJson(Map<String, dynamic> json) => _$ProductActionResponseFromJson(json);
//require keysetting
}
...
abstract class DimData with _$DimData {
  ...
  factory DimData.fromJson(Map<String, dynamic> json) => _$DimDataFromJson(json);
//require keysetting
}
...
abstract class DimItem with _$DimItem {
  ...
  factory DimItem.fromJson(Map<String, dynamic> json) => _$DimItemFromJson(json);
//require keysetting
}
...
abstract class AreaInfo with _$AreaInfo {
  ...
  factory AreaInfo.fromJson(Map<String, dynamic> json) => _$AreaInfoFromJson(json);
//require keysetting
}
...
abstract class Categoryinfo with _$Categoryinfo {
  factory Categoryinfo({
    ...
    @JsonKey(name:'dynamicpropertiesidentifier')String dynamicpropertiesidentifier,
...
abstract class productinorder with _$productinorder {
  ...
  factory productinorder.fromJson(Map<String, dynamic> json) => _$productinorderFromJson(json);
//require keysetting
}
...
abstract class orderinfomodel with _$orderinfomodel {
  factory orderinfomodel({
    ...
    @JsonKey(name:'orderdate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime orderdate,
...
abstract class LuceneSearchSuggestionData with _$LuceneSearchSuggestionData {
  ...
  factory LuceneSearchSuggestionData.fromJson(Map<String, dynamic> json) => _$LuceneSearchSuggestionDataFromJson(json);
//require keysetting
}
...
abstract class Sortfielddata with _$Sortfielddata {
  ...
  factory Sortfielddata.fromJson(Map<String, dynamic> json) => _$SortfielddataFromJson(json);
//require keysetting
}
...
abstract class NumericFilterData with _$NumericFilterData {
  ...
  factory NumericFilterData.fromJson(Map<String, dynamic> json) => _$NumericFilterDataFromJson(json);
//require keysetting
}
...
abstract class FacetParaFilter with _$FacetParaFilter {
  ...
  factory FacetParaFilter.fromJson(Map<String, dynamic> json) => _$FacetParaFilterFromJson(json);
//require keysetting
}
...
abstract class ProductFilterModel with _$ProductFilterModel {
  ...
  factory ProductFilterModel.fromJson(Map<String, dynamic> json) => _$ProductFilterModelFromJson(json);
//require keysetting
}
...
abstract class ProductFilterResultModel with _$ProductFilterResultModel {
  ...
  factory ProductFilterResultModel.fromJson(Map<String, dynamic> json) => _$ProductFilterResultModelFromJson(json);
//require keysetting
}
...
abstract class SpatialData with _$SpatialData {
  ...
  factory SpatialData.fromJson(Map<String, dynamic> json) => _$SpatialDataFromJson(json);
//require keysetting
}
...
abstract class ServiceFilterParameter with _$ServiceFilterParameter {
  factory ServiceFilterParameter({
    @JsonKey(name:'serviceofferedselectedvalues')ProductSearchInformationConfig serviceofferedselectedvalues,
    @JsonKey(name:'textsearch')String textsearch,
    @JsonKey(name:'offset')int offset,

  }) = _ServiceFilterParameter;
  factory ServiceFilterParameter.fromJson(Map<String, dynamic> json) => _$ServiceFilterParameterFromJson(json);
//require keysetting
}
...
abstract class ExplorePageAd with _$ExplorePageAd {
  ...
  factory ExplorePageAd.fromJson(Map<String, dynamic> json) => _$ExplorePageAdFromJson(json);
//require keysetting
}
...
abstract class ServiceFilterResultData with _$ServiceFilterResultData {
  ...
  factory ServiceFilterResultData.fromJson(Map<String, dynamic> json) => _$ServiceFilterResultDataFromJson(json);
//require keysetting
}
...
abstract class LimitedServiceModel with _$LimitedServiceModel {
  ...
  factory LimitedServiceModel.fromJson(Map<String, dynamic> json) => _$LimitedServiceModelFromJson(json);
//require keysetting
}

@freezed
abstract class ProductSearchInformationConfig with _$ProductSearchInformationConfig {
  ...
  factory ProductSearchInformationConfig.fromJson(Map<String, dynamic> json) => _$ProductSearchInformationConfigFromJson(json);
//require keysetting
}
...
abstract class SPCustomerModel with _$SPCustomerModel {
  factory SPCustomerModel({
    ...
    @JsonKey(name:'email')String email,
    @JsonKey(name:'names')List<CustomerNameAgeIngo> names,
    @JsonKey(name:'addressinfolist')List<AddressDataModel> addressInfolist,

  }) = _SPCustomerModel;
  factory SPCustomerModel.fromJson(Map<String, dynamic> json) => _$SPCustomerModelFromJson(json);
//require keysetting
}
...
abstract class CustomerNameAgeIngo with _$CustomerNameAgeIngo {
  factory CustomerNameAgeIngo({
    @JsonKey(name:'name')String name,
    @JsonKey(name:'dob', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime dob,
    @JsonKey(name:'gender')String gender,

  }) = _CustomerNameAgeIngo;
  factory CustomerNameAgeIngo.fromJson(Map<String, dynamic> json) => _$CustomerNameAgeIngoFromJson(json);
//require keysetting
}
...
abstract class ServiceTypeFilterData with _$ServiceTypeFilterData {
  ...
  factory ServiceTypeFilterData.fromJson(Map<String, dynamic> json) => _$ServiceTypeFilterDataFromJson(json);
//require keysetting
}
...
abstract class ServiceTypeFilterValues with _$ServiceTypeFilterValues {
  ...
  factory ServiceTypeFilterValues.fromJson(Map<String, dynamic> json) => _$ServiceTypeFilterValuesFromJson(json);
//require keysetting
}
...
abstract class ExplorePageParameters with _$ExplorePageParameters {
  ...
  factory ExplorePageParameters.fromJson(Map<String, dynamic> json) => _$ExplorePageParametersFromJson(json);
//require keysetting
}

@freezed
abstract class NumericFilterForIndex with _$NumericFilterForIndex {
  factory NumericFilterForIndex({
    @JsonKey(name:'fieldname')String fieldname,
    @JsonKey(name:'value')int value,

  }) = _NumericFilterForIndex;
  factory NumericFilterForIndex.fromJson(Map<String, dynamic> json) => _$NumericFilterForIndexFromJson(json);
//require keysetting
}

@freezed
abstract class SingleFacetField with _$SingleFacetField {
  factory SingleFacetField({
    @JsonKey(name:'fieldname')String fieldname,
    @JsonKey(name:'value')String value,

  }) = _SingleFacetField;
  factory SingleFacetField.fromJson(Map<String, dynamic> json) => _$SingleFacetFieldFromJson(json);
//require keysetting
}
