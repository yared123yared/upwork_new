...
class _PackageDetailFormState extends State<PackageDetailForm> {
  ...
  Widget _renderForm() {
    return SingleChildScrollView(
      ...
      children: [
        ...
        _renderTextField("ID", _idController,initialValue: widget.packageData?.packageid),
        _renderBarCode(),
        _renderTextField("Title", _titleController,initialValue: widget.packageData?.title),
        ...
        _renderTextField(
          "Price",
          _priceController,
          isInt: true,initialValue: widget.packageData?.price?.toString()
        ),
        _renderTextField(
          "Discount Price",
          _discountPriceController,
          isInt: true,initialValue: widget.packageData?.discountedprice?.toString()
        ),
        ...
        _renderTextField(
          ...
          initialValue:widget.packageData?.inventoryunits.toString(),
          isInt: true,
        ),
        _renderTextField(
          "Units in Package",
          _unitsInPackageController,
          isInt: true,initialValue:widget.packageData?.unit.toString()
        ),
        Padding(
  ...
  Widget _renderBarCode() {
    return Padding(
      ...
      child: CustomTextField(
        initialValue:widget.packageData?.barcodeid,
        title: 'BarCode ID ',
