...
import 'package:complex/pages/job_pages/add_job_page.dart';
import 'package:complex/pages/pet_pages/add_pet_page.dart';
import 'package:complex/pages/product_pages/select_product_type.dart';
import 'package:complex/pages/property/add_property_page.dart';
import 'package:complex/pages/vehicle/vehicle_create_page.dart';
...
class GeneralContactDetailPage extends StatefulWidget {
  ...
  GeneralContactDetailPage({this.type, this.serviceId, this.isService = false,this.serviceProviderId});
