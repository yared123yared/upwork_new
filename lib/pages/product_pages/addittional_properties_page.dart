...
import 'package:complex/pages/product_pages/package_list_view.dart';
            ...
            child: CustomButton(
              onTap: () {
                ...
                if (widget.productType == ProductType.noPackage) {
                  _productBloc.add(AddNoPackageEvent(model: _model, userId: UserSession.userId));
              ...
              text: widget.productType == ProductType.noPackage ? "Save":"Next",
