...
import 'package:complex/pages/product_pages/size_and_color_list_view.dart';
...
class _SizeAndColorDetailViewState extends State<SizeAndColorDetailView> {
  ...
  Widget _renderForm() {
    return SingleChildScrollView(
      ...
      children: [
        ...
        _renderTextField("Price", _priceController,isInt: true),
        _renderTextField("Discount Price", _discountPriceController,isInt: true),
        GroupTitle(text: 'Inventary Info'),
        _renderDropDown("Unit", _unitController, _unitList),
        _renderTextField("Inventory Unit", _inventoryUnitController,isInt: true),
        _renderTextField("Units in Package", _unitsInPackageController,isInt: true),
        Padding(
  ...
  Widget _renderTextField(String text, CustomTextFieldController controller,{bool isInt = false}) {
    return Padding(
