...
import 'package:complex/pages/complex_pages/create_complex_page.dart';
...
import 'package:complex/pages/services_page/create_service_page.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  List<SimpleEntity> complexNames = new List();
  List<SimpleEntity> serviceName = new List();
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () {
                          Navigator.push(widget.homeContext,
                              NextPageRoute(PhoneVerificationPage(value: 1,)));
                        },
                        icon: Icon(
                          Icons.edit,
                          color: Colors.white,
