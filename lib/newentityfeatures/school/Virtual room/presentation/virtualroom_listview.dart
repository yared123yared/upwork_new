...
import './virtual_room_form.dart';

class VirtualRoomModelListList extends StatefulWidget {
  final String entityid;
  final String entitytype;
  VirtualRoomModelListList({this.entitytype, this.entityid});

  @override
  _VirtualRoomModelListListState createState() =>
      _VirtualRoomModelListListState();
}

class _VirtualRoomModelListListState extends State<VirtualRoomModelListList> {
  listbloc.VirtualRoomModelListBloc mlistbloc;
  ...
  List<VirtualRoomModelNewFormat> em;
  ...
  VoidCallback addButtonActions({
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => VirtualRoomForm(
            virtualRoomModel: null,
  ...
  List<ListStateClass> toCommonListState(
      List<VirtualRoomModelNewFormat> listItems, BuildContext context) {
    ...
    listItems.asMap().forEach((index, item) {
      _dynamicList.add(ListStateClass(
        ...
        deleteAction: () async {
          ...
          if (docancel) {
            BlocProvider.of<listbloc.VirtualRoomModelListBloc>(context).add(
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      child: Scaffold(
          ...
          }, child: BlocBuilder<listbloc.VirtualRoomModelListBloc,
              listbloc.VirtualRoomModelListState>(builder: (context, state) {
