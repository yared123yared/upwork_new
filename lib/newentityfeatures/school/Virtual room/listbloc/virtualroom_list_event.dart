...
class VirtualRoomModelListEvent extends Equatable {
  const VirtualRoomModelListEvent();
  List<Object> get props => [];
}

class getPreData extends VirtualRoomModelListEvent {
...
//to get listdata
class getListData extends VirtualRoomModelListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends VirtualRoomModelListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends VirtualRoomModelListEvent {
  final VirtualRoomModelNewFormat item;
  final String entityid;
  final String entitytype;
