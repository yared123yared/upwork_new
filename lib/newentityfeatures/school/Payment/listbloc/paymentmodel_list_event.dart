...
class PaymentModelListEvent extends Equatable {
  const PaymentModelListEvent();
  List<Object> get props => [];
}

class getPreData extends PaymentModelListEvent {
...
//to get listdata
class getListData extends PaymentModelListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends PaymentModelListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends PaymentModelListEvent {
