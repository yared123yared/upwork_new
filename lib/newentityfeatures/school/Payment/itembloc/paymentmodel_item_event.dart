...
class PaymentModelEvent extends Equatable {
  const PaymentModelEvent();
  @override
  List<Object> get props => [];
}

class createItem extends PaymentModelEvent {
...
class updateItem extends PaymentModelEvent {
  final PaymentPeriodInfo item;
  final String entityid;
  final String entitytype;
  const updateItem({
...
class updateItemWithDiff extends PaymentModelEvent {
  final PaymentPeriodInfo newitem;
  final PaymentPeriodInfo olditem;
  final String entityid;
  final String entitytype;
...
class deleteItem extends PaymentModelEvent {
  final PaymentPeriodInfo item;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends PaymentModelEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends PaymentModelEvent {
  final String entityid;
  final String entitytype;
