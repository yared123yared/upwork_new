...
import './create_assignment_form.dart';

class CreateAssignmentList extends StatefulWidget {
  final String entityid;
  final String entitytype;
  CreateAssignmentList({this.entitytype, this.entityid});

  @override
  _CreateAssignmentListState createState() => _CreateAssignmentListState();
}

class _CreateAssignmentListState extends State<CreateAssignmentList> {
  listbloc.CreateAssignmentListBloc mlistbloc;
  ...
  VoidCallback addButtonActions({
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BlocProvider<itembloc.CreateAssignmentBloc>(
            create: (context) => itembloc.CreateAssignmentBloc()
              ..add(
  ...
  List<ListStateClass> toCommonListState(
      List<AssignmentModel> listItems, BuildContext context) {
    List<ListStateClass> _dynamicList = [];
    listItems.asMap().forEach((index, assignment) {
      _dynamicList.add(
        ListStateClass(
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      child: Scaffold(
          ...
          }, child: BlocBuilder<listbloc.CreateAssignmentListBloc,
              listbloc.CreateAssignmentListState>(builder: (context, state) {
