...
class SessionRegistrationEvent extends Equatable {
  const SessionRegistrationEvent();
  @override
  List<Object> get props => [];
}

class createItem extends SessionRegistrationEvent {
...
class updateItem extends SessionRegistrationEvent {
  final UserSessionRegModel item;
  final String entityid;
  final String entitytype;
  const updateItem({
...
class updateItemWithDiff extends SessionRegistrationEvent {
  final UserSessionRegModel newitem;
  final UserSessionRegModel olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends SessionRegistrationEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends SessionRegistrationEvent {
  final String entityid;
  final String entitytype;
  ...
  List<Object> get() => [entityid, entitytype, sessionTerm, cardNum];
}
