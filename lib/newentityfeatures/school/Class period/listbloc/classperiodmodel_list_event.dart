...
class ClassPeriodModelListEvent extends Equatable {
  const ClassPeriodModelListEvent();
  List<Object> get props => [];
}

class getPreData extends ClassPeriodModelListEvent {
...
//to get listdata
class getListData extends ClassPeriodModelListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends ClassPeriodModelListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends ClassPeriodModelListEvent {
