...
class TeacherAssignmentModelEvent extends Equatable {
  const TeacherAssignmentModelEvent();
  @override
  List<Object> get props => [];
}

class createItem extends TeacherAssignmentModelEvent {
...
class updateItem extends TeacherAssignmentModelEvent {
  final TeacherOfferingsAssignment item;
  final String entityid;
  final String entitytype;
  const updateItem({
...
class updateItemWithDiff extends TeacherAssignmentModelEvent {
  final TeacherOfferingsAssignment newitem;
  final TeacherOfferingsAssignment olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends TeacherAssignmentModelEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends TeacherAssignmentModelEvent {
  final String entityid;
  final String entitytype;
