...
import 'teacher_offering_assingment_form.dart';

class TeacherAssignmentModelListList extends StatefulWidget {
  final String entityid;
  final String entitytype;
  TeacherAssignmentModelListList({this.entitytype, this.entityid});

  @override
  _TeacherAssignmentModelListListState createState() =>
      _TeacherAssignmentModelListListState();
}

class _TeacherAssignmentModelListListState
    extends State<TeacherAssignmentModelListList> {
  listbloc.TeacherAssignmentModelListBloc mlistbloc;
  ...
  List<TeacherOfferingsAssignment> em;
  Future<List<String>> Function(String, String) offeringModelGroupfunc;
  void initState() {
    super.initState();
    mlistbloc = new listbloc.TeacherAssignmentModelListBloc();
  ...
  VoidCallback addButtonActions({
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => TeacherAssignmentModelForm(
            teacherOfferingsAssignment: null,
  ...
  List<ListStateClass> toCommonListState(
      List<TeacherOfferingsAssignment> listItems, BuildContext context) {
    ...
    listItems.asMap().forEach((index, item) {
      _dynamicList.add(ListStateClass(
        ...
        deleteAction: () async {
          ...
          if (docancel) {
            BlocProvider.of<listbloc.TeacherAssignmentModelListBloc>(context)
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      child: Scaffold(
          appBar: AppBar(
            title: Text("Offering Assignment List"),
            centerTitle: true,
          ),
          body: BlocListener<
              listbloc.TeacherAssignmentModelListBloc,
              listbloc
                  .TeacherAssignmentModelListState>(listener: (context, state) {
          ...
          }, child: BlocBuilder<listbloc.TeacherAssignmentModelListBloc,
                  listbloc.TeacherAssignmentModelListState>(
