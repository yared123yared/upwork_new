...
class FeeItemGroupsModelListEvent extends Equatable {
  const FeeItemGroupsModelListEvent();
  List<Object> get props => [];
}

class getPreData extends FeeItemGroupsModelListEvent {
...
//to get listdata
class getListData extends FeeItemGroupsModelListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends FeeItemGroupsModelListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends FeeItemGroupsModelListEvent {
