...
class FeeItemGroupsModelEvent extends Equatable {
  const FeeItemGroupsModelEvent();
  @override
  List<Object> get props => [];
}

class createItem extends FeeItemGroupsModelEvent {
  final FeeItemGroupsModel item;
...
class updateItem extends FeeItemGroupsModelEvent {
  final FeeItemGroupsModel item;
  final String entityid;
  final String entitytype;
  const updateItem({
...
class updateItemWithDiff extends FeeItemGroupsModelEvent {
  final FeeItemGroupsModel newitem;
  final FeeItemGroupsModel olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends FeeItemGroupsModelEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends FeeItemGroupsModelEvent {
  final String entityid;
  final String entitytype;
