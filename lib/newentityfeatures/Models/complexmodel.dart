...
abstract class ComplexVehicleModel with _$ComplexVehicleModel {
  factory ComplexVehicleModel({
    ...
    @JsonKey(name:'enddate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime endDate,
    @JsonKey(name:'startdate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime startDate,
  ...
  factory ComplexVehicleModel.fromJson(Map<String, dynamic> json) => _$ComplexVehicleModelFromJson(json);
//require keysetting
}
...
abstract class EntryLogModel with _$EntryLogModel {
  factory EntryLogModel({
    @JsonKey(name:'loggedinsecurity')String loggedInSecurity,
    @JsonKey(name:'logtype')String logType,
    @JsonKey(name:'userid')String userId,
    @JsonKey(name:'identity')String identity,
    @JsonKey(name:'servicerequid')String servicerequid,
    @JsonKey(name:'entrytype')String entrytype,
    @JsonKey(name:'logid')String logID,
    @JsonKey(name:'timedate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime timeDate,
    String id

  }) = _EntryLogModel;
  factory EntryLogModel.fromJson(Map<String, dynamic> json) => _$EntryLogModelFromJson(json);
...
abstract class QRCodeModel with _$QRCodeModel {
  factory QRCodeModel({
    @JsonKey(name:'entitytpe')String entityTpe,
    @JsonKey(name:'identity')String identity,
    @JsonKey(name:'userid')String userid,
    @JsonKey(name:'residentdetailsid')String residentdetailsid,
    @JsonKey(name:'foruserid')String foruserid,
    @JsonKey(name:'forservicereqid')String forservicereqid,
    @JsonKey(name:'startdate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime startdate,
    @JsonKey(name:'enddate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp) DateTime enddate,
    String id
...
abstract class RegistryModel with _$RegistryModel {
  factory RegistryModel({
    ...
    @JsonKey(name:'residentmanagementposition')String residentManagementPosition,
    @JsonKey(name:'ownername')String ownerName,
    ...
    @JsonKey(name:'ownerenddate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime ownerEndDate,
    @JsonKey(name:'ownerstartdate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime ownerStartDate,
    @JsonKey(name:'residentstartdate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime residentStartDate,
    @JsonKey(name:'residentenddate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime residentEndDate,
    @JsonKey(name:'version')num version,

  }) = _RegistryModel;
  factory RegistryModel.fromJson(Map<String, dynamic> json) => _$RegistryModelFromJson(json);
//require keysetting
}
...
abstract class ResidentModel with _$ResidentModel {
  ...
  factory ResidentModel.fromJson(Map<String, dynamic> json) => _$ResidentModelFromJson(json);
//require keysetting
}
...
abstract class ServiceRequestModel with _$ServiceRequestModel {
  factory ServiceRequestModel({
    ...
    @JsonKey(name:'servicerequestormemberuserid')String serviceRequestorMemberUserId,
    ...
    @JsonKey(name:'startdate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime startDate,
    @JsonKey(name:'enddate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime endDate,
    @JsonKey(name:'requesteddate', fromJson: JsonHelper.fromJsonTimeStamp, toJson: JsonHelper.toJsonTimeStamp)DateTime requestedDate,
