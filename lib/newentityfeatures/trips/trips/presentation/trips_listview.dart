...
import './route_trip_form.dart';

class RouteTripListList extends StatefulWidget {
  final String entityid;
  final String entitytype;
  RouteTripListList({this.entitytype, this.entityid});

  @override
  _RouteTripListListState createState() => _RouteTripListListState();
}

class _RouteTripListListState extends State<RouteTripListList> {
  listbloc.RouteTripListBloc mlistbloc;
  ...
  List<ListStateClass> toCommonListState(
      List<RouteTripModel> listItems, BuildContext context) {
    List<ListStateClass> _dynamicList = [];
    listItems.asMap().forEach((index, item) {
      _dynamicList.add(ListStateClass(
        title: "${item.name ?? ''} - ${item.routeName ?? ""}",
        tapAction: () {
          Navigator.push(
            context,
            MaterialPageRoute(
        ...
        deleteAction: () async {
          ...
          if (docancel) {
            BlocProvider.of<listbloc.RouteTripListBloc>(context).add(
    ...
    return BlocProvider.value(
      ...
      child: Scaffold(
          ...
          body: BlocListener<listbloc.RouteTripListBloc,
              listbloc.RouteTripListState>(listener: (context, state) {
          ...
          }, child: BlocBuilder<listbloc.RouteTripListBloc,
              listbloc.RouteTripListState>(builder: (context, state) {
