...
class RouteTripListEvent extends Equatable {
  const RouteTripListEvent();
  List<Object> get props => [];
}

class getPreData extends RouteTripListEvent {
...
//to get listdata
class getListData extends RouteTripListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends RouteTripListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends RouteTripListEvent {
