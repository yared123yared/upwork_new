...
class PointOfInterestListEvent extends Equatable {
  const PointOfInterestListEvent();
  List<Object> get props => [];
}

class getPreData extends PointOfInterestListEvent {
...
//to get listdata
class getListData extends PointOfInterestListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends PointOfInterestListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends PointOfInterestListEvent {
