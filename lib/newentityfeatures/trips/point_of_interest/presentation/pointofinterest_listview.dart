...
import 'point_of_interest_form.dart';

class PointOfInterestListList extends StatefulWidget {
  final String entityid;
  final String entitytype;
  PointOfInterestListList({this.entitytype, this.entityid});

  @override
  _PointOfInterestListListState createState() =>
      _PointOfInterestListListState();
}

class _PointOfInterestListListState extends State<PointOfInterestListList> {
  listbloc.PointOfInterestListBloc mlistbloc;
  ...
  VoidCallback addButtonActions({
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PointOfInterestForm(
            routePoint: null,
  ...
  List<ListStateClass> toCommonListState(
      List<RoutePointsModel> listItems, BuildContext context) {
    ...
    listItems.asMap().forEach((index, item) {
      _dynamicList.add(ListStateClass(
        ...
        deleteAction: () async {
          ...
          if (docancel) {
            BlocProvider.of<listbloc.PointOfInterestListBloc>(context).add(
    ...
    return BlocProvider.value(
      ...
      child: Scaffold(
          ...
          body: BlocListener<listbloc.PointOfInterestListBloc,
              listbloc.PointOfInterestListState>(listener: (context, state) {
          ...
          }, child: BlocBuilder<listbloc.PointOfInterestListBloc,
              listbloc.PointOfInterestListState>(builder: (context, state) {
