...
class HandleRelationListEvent extends Equatable {
  const HandleRelationListEvent();
  List<Object> get props => [];
}

class getPreData extends HandleRelationListEvent {
...
//to get listdata
class getListData extends HandleRelationListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends HandleRelationListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends HandleRelationListEvent {
