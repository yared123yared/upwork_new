...
class VehicleRelationListEvent extends Equatable {
  const VehicleRelationListEvent();
  List<Object> get props => [];
}

class getPreData extends VehicleRelationListEvent {
...
//to get listdata
class getListData extends VehicleRelationListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends VehicleRelationListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends VehicleRelationListEvent {
  final Relation item;
  final String entityid;
  final String entitytype;
