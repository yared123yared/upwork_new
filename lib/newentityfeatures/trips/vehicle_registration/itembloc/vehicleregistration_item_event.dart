...
class VehicleRegistrationEvent extends Equatable {
  const VehicleRegistrationEvent();
  @override
  List<Object> get props => [];
}

// class createGeneralInfoType extends VehicleRegistrationEvent {
//   final ServiceVehicleModel item;
//   final String entityid;
//   final String entitytype;
//   const createGeneralInfoType({
//     @required this.item,
...
// class deleteGeneralInfoType extends VehicleRegistrationEvent {
//   final ServiceVehicleModel item;
//   final String entityid;
//   final String entitytype;
//   const deleteGeneralInfoType({
//     @required this.item,
//     @required this.entityid,
//     @required this.entitytype,
//   });
...
class createItem extends VehicleRegistrationEvent {
  final ServiceVehicleModel item;
  final String entityid;
  final String entitytype;
  const createItem({
...
class updateItem extends VehicleRegistrationEvent {
  final ServiceVehicleModel item;
  final String entityid;
  final String entitytype;
  const updateItem({
...
class updateItemWithDiff extends VehicleRegistrationEvent {
  final ServiceVehicleModel newitem;
  final ServiceVehicleModel olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends VehicleRegistrationEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends VehicleRegistrationEvent {
  final String entityid;
  final String entitytype;
