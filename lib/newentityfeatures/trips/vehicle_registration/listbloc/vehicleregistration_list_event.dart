...
class VehicleRegistrationListEvent extends Equatable {
  const VehicleRegistrationListEvent();
  List<Object> get props => [];
}

class getPreData extends VehicleRegistrationListEvent {
...
//to get listdata
class getListData extends VehicleRegistrationListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends VehicleRegistrationListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends VehicleRegistrationListEvent {
