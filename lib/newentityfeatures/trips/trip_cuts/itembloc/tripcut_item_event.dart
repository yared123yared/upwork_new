...
class TripCutEvent extends Equatable {
  const TripCutEvent();
  @override
  List<Object> get props => [];
}

class TripSearchFetched extends TripCutEvent {
...
class createItem extends TripCutEvent {
  final TripCut item;
  final String entityid;
  final String entitytype;
  const createItem({
...
class updateItem extends TripCutEvent {
  final TripCut item;
  final String entityid;
  final String entitytype;
  const updateItem({
...
class updateItemWithDiff extends TripCutEvent {
  final TripCut newitem;
  final TripCut olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends TripCutEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends TripCutEvent {
  final String entityid;
  final String entitytype;
