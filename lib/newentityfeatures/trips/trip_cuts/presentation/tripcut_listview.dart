...
class TripCutListList extends StatefulWidget {
...
class _TripCutListListState extends State<TripCutListList> {
  listbloc.TripCutListBloc mlistbloc;
  ...
  List<ListStateClass> toCommonListState(
      List<TripCut> listItems, BuildContext context) {
    ...
    listItems.asMap().forEach((index, item) {
      _dynamicList.add(ListStateClass(
        ...
        deleteAction: () async {
          ...
          if (docancel) {
            BlocProvider.of<listbloc.TripCutListBloc>(context).add(
    ...
    return BlocProvider.value(
      ...
      child: Scaffold(
          ...
          body: BlocListener<listbloc.TripCutListBloc,
              listbloc.TripCutListState>(listener: (context, state) {
