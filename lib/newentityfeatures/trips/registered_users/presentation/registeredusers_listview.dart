...
import './registered_users_form.dart';
import 'package:complex/newentityfeatures/trips/model/models/registered_user.dart';

class RegisteredUsersListList extends StatefulWidget {
  final String entityid;
  final String entitytype;
  RegisteredUsersListList({this.entitytype, this.entityid});

  @override
  _RegisteredUsersListListState createState() =>
      _RegisteredUsersListListState();
}

class _RegisteredUsersListListState extends State<RegisteredUsersListList> {
  listbloc.RegisteredUsersListBloc mlistbloc;
  ...
  VoidCallback addButtonActions({
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => RegisteredUsersForm(
            registeredUser: null,
  ...
  List<ListStateClass> toCommonListState(
      List<RegisteredUser> listItems, BuildContext context) {
    ...
    listItems.asMap().forEach((index, item) {
      _dynamicList.add(ListStateClass(
        ...
        deleteAction: () async {
          ...
          if (docancel) {
            BlocProvider.of<listbloc.RegisteredUsersListBloc>(context).add(
    ...
    return BlocProvider.value(
      ...
      child: Scaffold(
          ...
          body: BlocListener<listbloc.RegisteredUsersListBloc,
              listbloc.RegisteredUsersListState>(listener: (context, state) {
          ...
          }, child: BlocBuilder<listbloc.RegisteredUsersListBloc,
              listbloc.RegisteredUsersListState>(builder: (context, state) {
