...
class RegisteredUsersListEvent extends Equatable {
  const RegisteredUsersListEvent();
  List<Object> get props => [];
}

class getPreData extends RegisteredUsersListEvent {
...
//to get listdata
class getListData extends RegisteredUsersListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends RegisteredUsersListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends RegisteredUsersListEvent {
