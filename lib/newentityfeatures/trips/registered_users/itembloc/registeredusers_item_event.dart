...
class RegisteredUsersEvent extends Equatable {
  const RegisteredUsersEvent();
  @override
  List<Object> get props => [];
}

class createItem extends RegisteredUsersEvent {
  final RegisteredUser item;
...
class updateItem extends RegisteredUsersEvent {
  final RegisteredUser item;
  final String entityid;
  final String entitytype;
  const updateItem({
...
class updateItemWithDiff extends RegisteredUsersEvent {
  final RegisteredUser newitem;
  final RegisteredUser olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends RegisteredUsersEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends RegisteredUsersEvent {
  final String entityid;
  final String entitytype;
