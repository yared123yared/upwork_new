...
// import 'package:complexanewentityfeaturesy/model/models.dart';
...
class RouteListList extends StatefulWidget {
...
class _RouteListListState extends State<RouteListList> {
  listbloc.RouteListBloc mlistbloc;
  ...
  List<ListStateClass> toCommonListState(
      List<RouteModel> listItems, BuildContext context) {
    ...
    listItems.asMap().forEach((index, item) {
      _dynamicList.add(ListStateClass(
        ...
        deleteAction: () async {
          ...
          if (docancel) {
            BlocProvider.of<listbloc.RouteListBloc>(context).add(
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
            child: CommonListPage(
                canSearch: false,
                updateAction: null,
                appBarTitle: "Route List",
                dynamicListState: "Route List",
