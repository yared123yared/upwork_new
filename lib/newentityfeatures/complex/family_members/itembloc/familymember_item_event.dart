...
class FamilyMemberEvent extends Equatable {
  const FamilyMemberEvent();
  @override
  List<Object> get props => [];
}

class createItem extends FamilyMemberEvent {
...
class updateItem extends FamilyMemberEvent {
  final FamilyMember item;
  final String entityid;
  final String entitytype;
  const updateItem({
...
class updateItemWithDiff extends FamilyMemberEvent {
  final FamilyMember newitem;
  final FamilyMember olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends FamilyMemberEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends FamilyMemberEvent {
  final String entityid;
  final String entitytype;
