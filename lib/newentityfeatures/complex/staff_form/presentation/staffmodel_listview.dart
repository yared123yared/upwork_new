...
class StaffModelListList extends StatefulWidget {
  final String entityid;
  final String entitytype;
  final int origintype;
  StaffModelListList({this.entitytype, this.entityid, this.origintype});

  @override
  _StaffModelListListState createState() => _StaffModelListListState();
}

class _StaffModelListListState extends State<StaffModelListList> {
  listbloc.StaffModelListBloc mlistbloc;
  ...
  VoidCallback addButtonActions({
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => StaffFormComplex(
            staffModel: null,
  ...
  List<ListStateClass> toCommonListState(
      List<StaffModelx> listItems, BuildContext context) {
    ...
    listItems.asMap().forEach((index, item) {
      _dynamicList.add(ListStateClass(
        ...
        deleteAction: () async {
          ...
          if (docancel) {
            BlocProvider.of<listbloc.StaffModelListBloc>(context).add(
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      child: Scaffold(
          ...
          }, child: BlocBuilder<listbloc.StaffModelListBloc,
              listbloc.StaffModelListState>(builder: (context, state) {
