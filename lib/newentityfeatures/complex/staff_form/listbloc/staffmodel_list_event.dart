...
class StaffModelListEvent extends Equatable {
  const StaffModelListEvent();
  List<Object> get props => [];
}

class getPreData extends StaffModelListEvent {
...
//to get listdata
class getListData extends StaffModelListEvent {
  final String entityid;
  final String entitytype;
...
class getListDataWithSearchParameter extends StaffModelListEvent {
  final String entityid;
  final String entitytype;
...
class deleteItemWithData extends StaffModelListEvent {
