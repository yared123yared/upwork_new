...
class StaffModelEvent extends Equatable {
  const StaffModelEvent();
  @override
  List<Object> get props => [];
}

class createItem extends StaffModelEvent {
  final StaffModelx item;
...
class updateItem extends StaffModelEvent {
  final StaffModelx item;
  final String entityid;
  final String entitytype;
  const updateItem({
...
class updateItemWithDiff extends StaffModelEvent {
  final StaffModelx newitem;
  final StaffModelx olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends StaffModelEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends StaffModelEvent {
  final String entityid;
  final String entitytype;
