...
class UnitModelEvent extends Equatable {
  const UnitModelEvent();
  @override
  List<Object> get props => [];
}

class createItem extends UnitModelEvent {
...
class updateItem extends UnitModelEvent {
  final UnitModel item;
  final String entityid;
  final String entitytype;
  const updateItem({
...
class updateItemWithDiff extends UnitModelEvent {
  final UnitModel newitem;
  final UnitModel olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends UnitModelEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends UnitModelEvent {
  final String entityid;
  final String entitytype;
