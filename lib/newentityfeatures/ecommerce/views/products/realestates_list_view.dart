...
class RealEstatesListView extends StatefulWidget {
  ...
  @override
  _RealEstatesListViewState createState() => _RealEstatesListViewState();
}

class _RealEstatesListViewState extends State<RealEstatesListView> {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return RealEstateCard(
                          realEstateModel: products[index],
                        );
                      },
                    );
                  },
