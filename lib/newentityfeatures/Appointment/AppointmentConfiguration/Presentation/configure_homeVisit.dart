...
class HomeVisitConfigure extends StatefulWidget {
  final Function onSaveHomeVisit;
  final HomeVisitModel homevisitmodel;
  HomeVisitConfigure({this.onSaveHomeVisit, this.homevisitmodel});

  @override
  _HomeVisitConfigureState createState() => _HomeVisitConfigureState();
}

class _HomeVisitConfigureState extends State<HomeVisitConfigure> {
  setData() {
    final model = widget.homevisitmodel;
  ...
  void submitData() {
    ...
    HomeVisitModel homeModel = HomeVisitModel(
      monStart: monStart,
      monEnd: monEnd,
      tueStart: tueStart,
      tueEnd: tueEnd,
    ...
    widget.onSaveHomeVisit(homeModel);
