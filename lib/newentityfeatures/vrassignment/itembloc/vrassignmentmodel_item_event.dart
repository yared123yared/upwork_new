...
class VrAssignmentModelEvent extends Equatable {
  const VrAssignmentModelEvent();
  @override
  List<Object> get props => [];
}


class createItem extends VrAssignmentModelEvent {
...
class updateItem extends VrAssignmentModelEvent {
...
class updateItemWithDiff extends VrAssignmentModelEvent {
...
class getAdditionalDataEntryIDAvailable extends VrAssignmentModelEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends VrAssignmentModelEvent {
