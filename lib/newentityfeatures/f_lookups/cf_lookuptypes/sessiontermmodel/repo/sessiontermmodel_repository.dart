...
class SessionTermModelRepository {
  Future<SessionTermModelRepositoryReturnData> getAllSessionTermModels(
	...
	SessionTermModelRepositoryReturnData myreturn = SessionTermModelRepositoryReturnData();
  ...
  Future<SessionTermModelRepositoryReturnData> updateSessionTermModelWithDiff(
      SessionTermModel newitem,SessionTermModel olditem, String entitytype, String entityid) async {
    return null;
  }
