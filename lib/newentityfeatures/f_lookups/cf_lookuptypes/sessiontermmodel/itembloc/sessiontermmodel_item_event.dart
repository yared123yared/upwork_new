...
class SessionTermModelEvent extends Equatable {
  const SessionTermModelEvent();
  @override
  List<Object> get props => [];
}


class createItem extends SessionTermModelEvent {
...
class updateItem extends SessionTermModelEvent {
...
class updateItemWithDiff extends SessionTermModelEvent {
  
  final SessionTermModel newitem;
  final SessionTermModel olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends SessionTermModelEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends SessionTermModelEvent {
