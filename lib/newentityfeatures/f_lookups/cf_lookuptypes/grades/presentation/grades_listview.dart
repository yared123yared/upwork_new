...
class GradesFormList extends StatefulWidget {
  final String entityid;
  final String entitytype;
  GradesFormList({this.entitytype, this.entityid});

  @override
  _GradesFormListState createState() => _GradesFormListState();
}

class _GradesFormListState extends State<GradesFormList> {
  ...
  Future<String> _addButtonActions(
    ...
    Future<String> sb = Get.generalDialog<String>(
      ...
      return AlertDialog(
        title: Text('Enter the Grade Name'),
