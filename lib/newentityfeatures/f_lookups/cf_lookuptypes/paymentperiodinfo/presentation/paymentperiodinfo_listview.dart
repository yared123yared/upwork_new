  ...
  VoidCallback addButtonActions({
    @required BuildContext context,
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder:(context) =>   PaymentPeriodInfoForm(paymentPeriodInfo: null,entitytype: widget.entitytype,entityid: widget.entityid,givenreloadaction:doreload),
          ),
        );
  }


  List<ListStateClass> toCommonListState(List<cmodel.PaymentPeriodInfo> listItems,
      BuildContext context)
  {
    ...
    listItems.asMap().forEach((index, item) {
      _dynamicList.add(ListStateClass(
        ...
        context,
        MaterialPageRoute(
          builder:(context) =>   PaymentPeriodInfoForm(paymentPeriodInfo: item,entitytype: widget.entitytype,entityid: widget.entityid,givenreloadaction:doreload),
          ),
        );
          },
        deleteAction: () async{
          ...
          if (docancel)
            {
              BlocProvider.of<listbloc.PaymentPeriodInfoListBloc>(context).add(listbloc. deleteItemWithData(entitytype:widget.entitytype,entityid:widget.entitytype,item:listItems[index]));
            }
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      child: Scaffold(
        ...
        body:BlocListener<listbloc.PaymentPeriodInfoListBloc,listbloc.PaymentPeriodInfoListState>(
        ...
        child:BlocBuilder<listbloc.PaymentPeriodInfoListBloc,listbloc.PaymentPeriodInfoListState>(builder: (context, state) {
