...
class PaymentPeriodInfoEvent extends Equatable {
  const PaymentPeriodInfoEvent();
  @override
  List<Object> get props => [];
}


class createItem extends PaymentPeriodInfoEvent {
...
class updateItem extends PaymentPeriodInfoEvent {
...
class updateItemWithDiff extends PaymentPeriodInfoEvent {
...
class getAdditionalDataEntryIDAvailable extends PaymentPeriodInfoEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends PaymentPeriodInfoEvent {
