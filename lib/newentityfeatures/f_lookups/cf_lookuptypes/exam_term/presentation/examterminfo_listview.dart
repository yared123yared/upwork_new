  ...
  VoidCallback addButtonActions({
    @required BuildContext context,
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder:(context) =>   ExamTermForm(examTermInfo: null,entitytype: widget.entitytype,entityid: widget.entityid,givenreloadaction:doreload),
          ),
        );
  }


  List<ListStateClass> toCommonListState(List<cmodel.ExamTermInfo> listItems,
...
subtitle : item.subTermName,
        ...
        context,
        MaterialPageRoute(
          builder:(context) =>   ExamTermForm(examTermInfo: item,entitytype: widget.entitytype,entityid: widget.entityid,givenreloadaction:doreload),
          ),
        );
          },
        deleteAction: () async{
          ...
          if (docancel)
            {
              BlocProvider.of<listbloc.ExamTermInfoListBloc>(context).add(listbloc. deleteItemWithData(entitytype:widget.entitytype,entityid:widget.entitytype,item:listItems[index]));
            }
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      child: Scaffold(
        ...
        body:BlocListener<listbloc.ExamTermInfoListBloc,listbloc.ExamTermInfoListState>(
        ...
        child:BlocBuilder<listbloc.ExamTermInfoListBloc,listbloc.ExamTermInfoListState>(builder: (context, state) {
