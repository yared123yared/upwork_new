...
class RoomInfoListBloc extends Bloc<RoomInfoListEvent, RoomInfoListState> {
  ...
  Stream<RoomInfoListState> mapEventToState(
    ...
    if (event is GetListData) {
      yield IsBusy();
      RoomInfoRepositoryReturnData ud =
          await mrepository.getAllRoomInfos(event.entitytype, event.entityid);
