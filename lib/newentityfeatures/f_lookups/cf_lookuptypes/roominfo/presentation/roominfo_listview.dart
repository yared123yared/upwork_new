...
import 'package:complex/newentityfeatures/f_lookups/cf_lookuptypes/roominfo/listbloc/bloc.dart' as listbloc;
import 'package:complex/newentityfeatures/f_lookups/model/lookups.dart' as cmodel;
  ...
  VoidCallback addButtonActions({
    @required BuildContext context,
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder:(context) =>   RoomForm(roomInfo: null,entitytype: widget.entitytype,entityid: widget.entityid,givenreloadaction:doreload),
          ),
        );
  }


  List<ListStateClass> toCommonListState(List<cmodel.RoomInfo> listItems,
...
subtitle : item.roomAddr,
        ...
        context,
        MaterialPageRoute(
          builder:(context) =>   RoomForm(roomInfo: item,entitytype: widget.entitytype,entityid: widget.entityid,givenreloadaction:doreload),
          ),
        );
          },
        deleteAction: () async{
          ...
          if (docancel)
            {
              BlocProvider.of<listbloc.RoomInfoListBloc>(context).add(listbloc. deleteItemWithData(entitytype:widget.entitytype,entityid:widget.entitytype,item:listItems[index]));
            }
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      child: Scaffold(
        ...
        body:BlocListener<listbloc.RoomInfoListBloc,listbloc.RoomInfoListState>(
        ...
        child:BlocBuilder<listbloc.RoomInfoListBloc,listbloc.RoomInfoListState>(builder: (context, state) {
