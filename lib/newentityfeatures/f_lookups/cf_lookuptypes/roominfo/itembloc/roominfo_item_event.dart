...
class RoomInfoEvent extends Equatable {
  const RoomInfoEvent();
  @override
...
class createItem extends RoomInfoEvent {
...
class updateItem extends RoomInfoEvent {
...
class updateItemWithDiff extends RoomInfoEvent {
  
  final RoomInfo newitem;
  final RoomInfo olditem;
  final String entityid;
  final String entitytype;
...
class getAdditionalDataEntryIDAvailable extends RoomInfoEvent {
  final String id;
  final String entityid;
  final String entitytype;
...
class getForNewEntry extends RoomInfoEvent {
