...
class StoreProductsFilter extends StatefulWidget {
  StoreProductsFilter({Key key}) : super(key: key);

  @override
  _StoreProductsFilterState createState() => _StoreProductsFilterState();
}

class _StoreProductsFilterState extends State<StoreProductsFilter> {
            ...
            selectedFilters
                .map(
                  (key, value) => MapEntry(
                    ...
                    FacetParaFilter(
                      paraname: key,
                      fieldvalues: value.map((e) => e.fieldvalue).toList(),
                    ),
                  ),
                )
                .values
