...
class _CommonListTileState extends State<CommonListTile> {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      margin: EdgeInsets.symmetric(vertical: height, horizontal: 0),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (widget.listState.tittleH3 != null)
                          Padding(
                            padding: const EdgeInsets.only(left: 8),
                            child: Text(
                              widget.listState.tittleH3 ?? "Error",
                              style: TextStyle(
                                fontFamily: 'Merriweather',
                                color: ColorConstants.primaryColor,
                                fontSize: 14,
                                ...
                                if (widget.listState.subtitle != null &&
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color:
                                            C.primaryTextBlue.withOpacity(0.8),
                                        borderRadius:
