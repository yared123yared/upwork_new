...
class CustomScrollingText extends StatefulWidget {
  ...
  /// ## Sample code
  ///
  /// This [CustomScrollingText] starts scrolling one second after being displayed.
  ///
  /// ```dart
  /// Marquee(
  ...
  /// The fraction of the [CustomScrollingText] that will be faded on the left or top.
  ...
  /// The fraction of the [CustomScrollingText] that will be faded on the right or down.
  /// By default, there won't be any fading.
  ///
  /// ## Sample code
  ///
  ...
  @override
  State<StatefulWidget> createState() => _CustomScrollingTextState();

  bool equals(Object other) {
    return other is CustomScrollingText &&
        text == other.text &&
        style == other.style &&
...
class _CustomScrollingTextState extends State<CustomScrollingText>
  ...
  ///if the text larger than the space
  bool _runnable = true;
  ...
  Future<void> _makeRoundTrip() async {
    ...
    if (!_controller.hasClients && _runnable) return;
  ...
  Widget build(BuildContext context) {
    ...
    Widget marquee = LayoutBuilder(
      builder: (context, constraints) {
        _runnable = _getTextWidth(context) > constraints.maxWidth;
